...
import { LogOut, Bell, ChevronRight, Train, Calendar, Building2, FolderKanban, Clock, CheckCircle2, FileText, AlertTriangle, TrendingUp } from "lucide-react";
...
import { AREA_LABELS, AREA_HEADS, type Area, riskCategory } from "@/lib/types";
...
export function JefeShell({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="max-w-[1300px] mx-auto px-6 py-7 flex gap-6">
